...
export default function InfraComp(props) {
  ...
  return (
    <>
      ...
      <div className='flex flex-col md:absolute lg:right-32 w-full h-auto md:h-96 md:grid grid-cols-3 py-5 md:py-10 lg:py-0 border border-gray-200 bg-white md:shadow-xl'>
        {/* Image Section */}
